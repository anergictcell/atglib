...
///
/// ```rust
/// use atglib::utils::relation;
/// use atglib::utils::GenomicRelation;
/// let a = (&3, &5);
/// let b = (&2, &3);
/// let c = relation(a, b);
...
///
/// ```rust
/// use atglib::utils::exon_cds_overlap;
/// let cds_start = 4;
/// let cds_end = 7;
/// let exon_start = 1;
/// let exon_end = 10;
